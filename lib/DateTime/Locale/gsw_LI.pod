...
DateTime::Locale::gsw_LI - Locale data examples for the gsw-LI locale.

=head1 DESCRIPTION

This pod file contains examples of the locale data available for the
Swiss German Liechtenstein locale.
