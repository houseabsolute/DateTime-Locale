...
DateTime::Locale::ca_ES_VALENCIA - Locale data examples for the ca-ES-VALENCIA locale.

=head1 DESCRIPTION

This pod file contains examples of the locale data available for the
Catalan Spain Valencian locale.
