...
is( $loc->default_date_format, 'yyyy MMM d', 'check default date format' );
is( $loc->default_time_format, 'HH:mm:ss', 'check default date format' );
...
is( $loc->default_date_format, 'yyyy-MM-dd', 'check default date format' );
is( $loc->default_time_format, 'HH:mm', 'check default date format' );
