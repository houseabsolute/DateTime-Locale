{
  ...
  available_formats => {
    ...
    GyM => "MM y G",
    GyMEd => "dd-MM-y, E, G",
    GyMMM => "LLL y\N{U+202f}'\N{U+0440}'. G",
    GyMMMEd => "E, d MMM y\N{U+202f}'\N{U+0440}'. G",
    GyMMMd => "d MMM y\N{U+202f}'\N{U+0440}'. G",
    GyMd => "dd-MM-y GGGGG",
    H => "H",
    Hm => "HH:mm",
    Hms => "HH:mm:ss",
    Hmsv => "HH:mm:ss v",
    Hmv => "HH:mm v",
    Hv => "HH '\N{U+0433}\N{U+043e}\N{U+0434}' v",
    M => "LL",
    MEd => "E, dd.MM",
    MMM => "LLL",
    MMMEd => "E, d MMM",
    ...
    yM => "MM.y",
    yMEd => "E, dd.MM.y",
    yMMM => "LLL y\N{U+202f}'\N{U+0440}'.",
    yMMMEd => "E, d MMM y\N{U+202f}'\N{U+0440}'.",
    yMMMM => "LLLL y\N{U+202f}'\N{U+0440}'.",
    yMMMd => "d MMM y\N{U+202f}'\N{U+0440}'.",
    yMd => "dd.MM.y",
    yQQQ => "QQQ y",
    yQQQQ => "QQQQ y\N{U+202f}'\N{U+0440}'.",
