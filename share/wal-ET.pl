{
  ...
  first_day_of_week => 7,
  glibc_date_1_format => "%A\N{U+1363} %B %e \N{U+130b}\N{U+120b}\N{U+1233} %r %Z %Y \N{U+130d}/\N{U+120b}",
  glibc_date_format => "%d/%m/%Y",
  glibc_datetime_format => "%A\N{U+1363} %B %e \N{U+130b}\N{U+120b}\N{U+1233} %Y %r %Z",
