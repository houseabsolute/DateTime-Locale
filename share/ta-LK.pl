{
  ...
  first_day_of_week => 1,
  glibc_date_1_format => "%A %d %B %Y %H:%M:%S %Z",
  glibc_date_format => "%-d/%-m/%y",
  glibc_datetime_format => "%A %d %B %Y %H:%M:%S",
  ...
  quarter_format_wide => [
    "\N{U+0bae}\N{U+0bc1}\N{U+0ba4}\N{U+0bb2}\N{U+0bcd} \N{U+0b95}\N{U+0bbe}\N{U+0bb2}\N{U+0bbe}\N{U+0ba3}\N{U+0bcd}\N{U+0b9f}\N{U+0bc1}",
