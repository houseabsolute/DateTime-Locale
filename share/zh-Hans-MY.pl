{
  ...
  name => "Chinese Malaysia Simplified",
  native_language => "\N{U+4e2d}\N{U+6587}",
  native_name => "\N{U+4e2d}\N{U+6587} \N{U+9a6c}\N{U+6765}\N{U+897f}\N{U+4e9a} \N{U+7b80}\N{U+4f53}",
  native_script => "\N{U+7b80}\N{U+4f53}",
  native_territory => "\N{U+9a6c}\N{U+6765}\N{U+897f}\N{U+4e9a}",
