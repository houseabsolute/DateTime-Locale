{
  ...
  name => "Cantonese China Traditional",
  native_language => "\N{U+7cb5}\N{U+8a9e}",
  native_name => "\N{U+7cb5}\N{U+8a9e} \N{U+4e2d}\N{U+570b} \N{U+7e41}\N{U+9ad4}",
  native_script => "\N{U+7e41}\N{U+9ad4}",
  native_territory => "\N{U+4e2d}\N{U+570b}",
