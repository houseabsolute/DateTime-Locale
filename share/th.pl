{
  ...
  day_format_abbreviated => [
    "\N{U+0e08}\N{U+0e31}\N{U+0e19}\N{U+0e17}\N{U+0e23}\N{U+0e4c}",
    "\N{U+0e2d}\N{U+0e31}\N{U+0e07}\N{U+0e04}\N{U+0e32}\N{U+0e23}",
    "\N{U+0e1e}\N{U+0e38}\N{U+0e18}",
    "\N{U+0e1e}\N{U+0e24}\N{U+0e2b}\N{U+0e31}\N{U+0e2a}",
    "\N{U+0e28}\N{U+0e38}\N{U+0e01}\N{U+0e23}\N{U+0e4c}",
    "\N{U+0e40}\N{U+0e2a}\N{U+0e32}\N{U+0e23}\N{U+0e4c}",
    "\N{U+0e2d}\N{U+0e32}\N{U+0e17}\N{U+0e34}\N{U+0e15}\N{U+0e22}\N{U+0e4c}",
  ],
  day_format_narrow => [
    "\N{U+0e08}",
    "\N{U+0e2d}",
