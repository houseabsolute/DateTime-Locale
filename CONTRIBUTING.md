...
If you use cpanminus, you can do it without downloading the tarball first:
    ...
    $ cpanm --reinstall --installdeps --with-recommends DateTime::Locale
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends DateTime::Locale
...
The code for this distribution is [hosted at GitHub](https://github.com/houseabsolute/DateTime-Locale).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=DateTime-Locale)
or [via email](bug-datetime-locale@rt.cpan.org.
...
template file originating in Dist-Zilla-PluginBundle-DROLSKY-0.74.
